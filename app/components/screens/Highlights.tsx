        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {highlights.map((item, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-playfair font-semibold mb-2 text-lime-700">
                {item.title}
              </h3>
